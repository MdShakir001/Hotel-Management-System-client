...
import { getBookingsByUserId, getUser , deleteUser } from '../utils/ApiFuncions'
...
const Profile = () => {
    ...
    useEffect(()=>{
      ...
      try{
        const userBookings=await getBookingsByUserId(userId,token)
									...
									<tbody>
										{bookings.map((booking, index) => (
											<tr key={index}>
												...
												<td className="text-success">{status(booking.checkOutDate)}</td>
											</tr>
										))}
									</tbody>
								</table>
