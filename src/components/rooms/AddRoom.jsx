...
import { addRoom } from '../utils/ApiFuncions';
        ...
        <div className="col-md-8 col-lg-6">
          ...
          <form  onSubmit={handleSubmit}>
            ...
            <div className='mb-3'>
              ...
              <input required type="number" className="form-control"  id="roomPrice" name="roomPrice" value={newRoom.roomPrice} 
            ...
            <div className='mb-3'>
              ...
              {imagePreview && (<img src={imagePreview} alt="Room image" 
